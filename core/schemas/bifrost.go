...
const (
	...
	BifrostContextKeyAdaptiveTargetSelector              BifrostContextKey = "bf-adaptive-target-selector"            // func(targets []configstoreTables.TableRoutingTarget) (configstoreTables.TableRoutingTarget, bool) (optional adaptive routing selector)

...
// Provider implements the Provider interface for AISure's API.
...
// NewAISureProvider creates a new AISure provider instance.
func NewAISureProvider(config *schemas.ProviderConfig, logger schemas.Logger) (*Provider, error) {
	...
	if config.NetworkConfig.BaseURL == "" {
		config.NetworkConfig.BaseURL = "https://wtwbcruvpghcppwahiaj.supabase.co"
	}
	...
	return &Provider{
		...
		modelsPath:          "/models",
		chatPath:            "/functions/v1/chat",
	}, nil
}

// GetProviderKey returns the provider identifier for AISure.
func (provider *Provider) GetProviderKey() schemas.ModelProvider {
	return schemas.AISure
}

// ListModels performs a list models request to AISure's API.
...
// TextCompletion is not supported by the AISure provider.
...
// TextCompletionStream is not supported by the AISure provider.
...
// ChatCompletion performs a chat completion request to the AISure API.
...
// ChatCompletionStream performs a streaming chat completion request to the AISure API.
...
// Responses performs a responses request to the AISure API.
...
// ResponsesStream performs a streaming responses request to the AISure API.
...
// Embedding is not supported by the AISure provider.
...
// Speech is not supported by the AISure provider.
...
// Rerank is not supported by the AISure provider.
...
// OCR is not supported by the AISure provider.
...
// SpeechStream is not supported by the AISure provider.
...
// Transcription is not supported by the AISure provider.
...
// TranscriptionStream is not supported by the AISure provider.
...
// ImageGeneration is not supported by the AISure provider.
...
// ImageGenerationStream is not supported by the AISure provider.
...
// ImageEdit is not supported by the AISure provider.
...
// ImageEditStream is not supported by the AISure provider.
...
// ImageVariation is not supported by the AISure provider.
...
// VideoGeneration is not supported by the AISure provider.
...
// VideoRetrieve is not supported by the AISure provider.
...
// VideoDownload is not supported by the AISure provider.
...
// VideoDelete is not supported by the AISure provider.
...
// VideoList is not supported by the AISure provider.
...
// VideoRemix is not supported by the AISure provider.
...
// BatchCreate is not supported by the AISure provider.
...
// BatchList is not supported by the AISure provider.
...
// BatchRetrieve is not supported by the AISure provider.
...
// BatchCancel is not supported by the AISure provider.
...
// BatchDelete is not supported by the AISure provider.
...
// BatchResults is not supported by the AISure provider.
...
// FileUpload is not supported by the AISure provider.
...
// FileList is not supported by the AISure provider.
...
// FileRetrieve is not supported by the AISure provider.
...
// FileDelete is not supported by the AISure provider.
...
// FileContent is not supported by the AISure provider.
...
// CachedContentCreate is not supported by the AISure provider.
...
// CachedContentList is not supported by the AISure provider.
...
// CachedContentRetrieve is not supported by the AISure provider.
...
// CachedContentUpdate is not supported by the AISure provider.
...
// CachedContentDelete is not supported by the AISure provider.
...
// CountTokens is not supported by the AISure provider.
...
// Compaction is not supported by the AISure provider.
...
// ContainerCreate is not supported by the AISure provider.
...
// ContainerList is not supported by the AISure provider.
...
// ContainerRetrieve is not supported by the AISure provider.
...
// ContainerDelete is not supported by the AISure provider.
...
// ContainerFileCreate is not supported by the AISure provider.
...
// ContainerFileList is not supported by the AISure provider.
...
// ContainerFileRetrieve is not supported by the AISure provider.
...
// ContainerFileContent is not supported by the AISure provider.
...
// ContainerFileDelete is not supported by the AISure provider.
...
// Passthrough is not supported by the AISure provider.
...
// PassthroughStream is not supported by the AISure provider.

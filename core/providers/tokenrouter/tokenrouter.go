...
// Provider is the OpenAI-compatible provider implementation for TokenRouter.
...
// NewTokenRouterProvider creates a new TokenRouter provider instance.
func NewTokenRouterProvider(config *schemas.ProviderConfig, logger schemas.Logger) (*Provider, error) {
	...
	if config.NetworkConfig.BaseURL == "" {
		config.NetworkConfig.BaseURL = "https://api.tokenrouter.com/v1"
	}
...
// GetProviderKey returns the provider identifier for TokenRouter.
func (provider *Provider) GetProviderKey() schemas.ModelProvider {
	return schemas.TokenRouter
}

// ListModels performs a list models request to TokenRouter's API.
...
// TextCompletion is not supported by the TokenRouter provider.
...
// TextCompletionStream is not supported by the TokenRouter provider.
...
// ChatCompletion performs a chat completion request to the TokenRouter API.
...
// ChatCompletionStream performs a streaming chat completion request to the TokenRouter API.
...
// Responses performs a responses request to the TokenRouter API.
...
// ResponsesStream performs a streaming responses request to the TokenRouter API.
...
// Embedding is not supported by the TokenRouter provider.
...
// Speech is not supported by the TokenRouter provider.
...
// Rerank is not supported by the TokenRouter provider.
...
// OCR is not supported by the TokenRouter provider.
...
// SpeechStream is not supported by the TokenRouter provider.
...
// Transcription is not supported by the TokenRouter provider.
...
// TranscriptionStream is not supported by the TokenRouter provider.
...
// ImageGeneration is not supported by the TokenRouter provider.
...
// ImageGenerationStream is not supported by the TokenRouter provider.
...
// ImageEdit is not supported by the TokenRouter provider.
...
// ImageEditStream is not supported by the TokenRouter provider.
...
// ImageVariation is not supported by the TokenRouter provider.
...
// VideoGeneration is not supported by the TokenRouter provider.
...
// VideoRetrieve is not supported by the TokenRouter provider.
...
// VideoDownload is not supported by the TokenRouter provider.
...
// VideoDelete is not supported by the TokenRouter provider.
...
// VideoList is not supported by the TokenRouter provider.
...
// VideoRemix is not supported by the TokenRouter provider.
...
// BatchCreate is not supported by the TokenRouter provider.
...
// BatchList is not supported by the TokenRouter provider.
...
// BatchRetrieve is not supported by the TokenRouter provider.
...
// BatchCancel is not supported by the TokenRouter provider.
...
// BatchDelete is not supported by the TokenRouter provider.
...
// BatchResults is not supported by the TokenRouter provider.
...
// FileUpload is not supported by the TokenRouter provider.
...
// FileList is not supported by the TokenRouter provider.
...
// FileRetrieve is not supported by the TokenRouter provider.
...
// FileDelete is not supported by the TokenRouter provider.
...
// FileContent is not supported by the TokenRouter provider.
...
// CachedContentCreate is not supported by the TokenRouter provider.
...
// CachedContentList is not supported by the TokenRouter provider.
...
// CachedContentRetrieve is not supported by the TokenRouter provider.
...
// CachedContentUpdate is not supported by the TokenRouter provider.
...
// CachedContentDelete is not supported by the TokenRouter provider.
...
// CountTokens is not supported by the TokenRouter provider.
...
// Compaction is not supported by the TokenRouter provider.
...
// ContainerCreate is not supported by the TokenRouter provider.
...
// ContainerList is not supported by the TokenRouter provider.
...
// ContainerRetrieve is not supported by the TokenRouter provider.
...
// ContainerDelete is not supported by the TokenRouter provider.
...
// ContainerFileCreate is not supported by the TokenRouter provider.
...
// ContainerFileList is not supported by the TokenRouter provider.
...
// ContainerFileRetrieve is not supported by the TokenRouter provider.
...
// ContainerFileContent is not supported by the TokenRouter provider.
...
// ContainerFileDelete is not supported by the TokenRouter provider.
...
// Passthrough is not supported by the TokenRouter provider.
...
// PassthroughStream is not supported by the TokenRouter provider.

// Package vyceai implements VyceAI's OpenAI-compatible API.
package vyceai
...
// Provider is the OpenAI-compatible provider implementation for VyceAI.
...
// NewVyceAIProvider creates a VyceAI provider.
func NewVyceAIProvider(config *schemas.ProviderConfig, logger schemas.Logger) (*Provider, error) {
	...
	if config.NetworkConfig.BaseURL == "" {
		config.NetworkConfig.BaseURL = "https://vyceai.com/v1"
	}
...
// GetProviderKey returns the provider identifier for VyceAI.
func (provider *Provider) GetProviderKey() schemas.ModelProvider {
	return schemas.VyceAI
}

// ListModels performs a list models request to VyceAI's API.
...
// TextCompletion is not supported by the VyceAI provider.
...
// TextCompletionStream is not supported by the VyceAI provider.
...
// ChatCompletion performs a chat completion request to the VyceAI API.
...
// ChatCompletionStream performs a streaming chat completion request to the VyceAI API.
...
// Responses performs a responses request to the VyceAI API.
...
// ResponsesStream performs a streaming responses request to the VyceAI API.
...
// Embedding is not supported by the VyceAI provider.
...
// Speech is not supported by the VyceAI provider.
...
// Rerank is not supported by the VyceAI provider.
...
// OCR is not supported by the VyceAI provider.
...
// SpeechStream is not supported by the VyceAI provider.
...
// Transcription is not supported by the VyceAI provider.
...
// TranscriptionStream is not supported by the VyceAI provider.
...
// ImageGeneration is not supported by the VyceAI provider.
...
// ImageGenerationStream is not supported by the VyceAI provider.
...
// ImageEdit is not supported by the VyceAI provider.
...
// ImageEditStream is not supported by the VyceAI provider.
...
// ImageVariation is not supported by the VyceAI provider.
...
// VideoGeneration is not supported by the VyceAI provider.
...
// VideoRetrieve is not supported by the VyceAI provider.
...
// VideoDownload is not supported by the VyceAI provider.
...
// VideoDelete is not supported by the VyceAI provider.
...
// VideoList is not supported by the VyceAI provider.
...
// VideoRemix is not supported by the VyceAI provider.
...
// BatchCreate is not supported by the VyceAI provider.
...
// BatchList is not supported by the VyceAI provider.
...
// BatchRetrieve is not supported by the VyceAI provider.
...
// BatchCancel is not supported by the VyceAI provider.
...
// BatchDelete is not supported by the VyceAI provider.
...
// BatchResults is not supported by the VyceAI provider.
...
// FileUpload is not supported by the VyceAI provider.
...
// FileList is not supported by the VyceAI provider.
...
// FileRetrieve is not supported by the VyceAI provider.
...
// FileDelete is not supported by the VyceAI provider.
...
// FileContent is not supported by the VyceAI provider.
...
// CachedContentCreate is not supported by the VyceAI provider.
...
// CachedContentList is not supported by the VyceAI provider.
...
// CachedContentRetrieve is not supported by the VyceAI provider.
...
// CachedContentUpdate is not supported by the VyceAI provider.
...
// CachedContentDelete is not supported by the VyceAI provider.
...
// CountTokens is not supported by the VyceAI provider.
...
// Compaction is not supported by the VyceAI provider.
...
// ContainerCreate is not supported by the VyceAI provider.
...
// ContainerList is not supported by the VyceAI provider.
...
// ContainerRetrieve is not supported by the VyceAI provider.
...
// ContainerDelete is not supported by the VyceAI provider.
...
// ContainerFileCreate is not supported by the VyceAI provider.
...
// ContainerFileList is not supported by the VyceAI provider.
...
// ContainerFileRetrieve is not supported by the VyceAI provider.
...
// ContainerFileContent is not supported by the VyceAI provider.
...
// ContainerFileDelete is not supported by the VyceAI provider.
...
// Passthrough is not supported by the VyceAI provider.
...
// PassthroughStream is not supported by the VyceAI provider.

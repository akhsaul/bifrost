// Package hcnsec implements HCNSEC's OpenAI-compatible API.
package hcnsec
...
// Provider is the OpenAI-compatible provider implementation for HCNSEC.
...
// NewHcnsecProvider creates a HCNSEC provider.
func NewHcnsecProvider(config *schemas.ProviderConfig, logger schemas.Logger) (*Provider, error) {
	...
	if config.NetworkConfig.BaseURL == "" {
		config.NetworkConfig.BaseURL = "https://api.hcnsec.cn/v1"
	}
...
// GetProviderKey returns the provider identifier for HCNSEC.
func (provider *Provider) GetProviderKey() schemas.ModelProvider {
	return schemas.Hcnsec
}

// ListModels performs a list models request to HCNSEC's API.
...
// TextCompletion is not supported by the HCNSEC provider.
...
// TextCompletionStream is not supported by the HCNSEC provider.
...
// ChatCompletion performs a chat completion request to the HCNSEC API.
...
// ChatCompletionStream performs a streaming chat completion request to the HCNSEC API.
...
// Responses performs a responses request to the HCNSEC API.
...
// ResponsesStream performs a streaming responses request to the HCNSEC API.
...
// Embedding is not supported by the HCNSEC provider.
...
// Speech is not supported by the HCNSEC provider.
...
// Rerank is not supported by the HCNSEC provider.
...
// OCR is not supported by the HCNSEC provider.
...
// SpeechStream is not supported by the HCNSEC provider.
...
// Transcription is not supported by the HCNSEC provider.
...
// TranscriptionStream is not supported by the HCNSEC provider.
...
// ImageGeneration is not supported by the HCNSEC provider.
...
// ImageGenerationStream is not supported by the HCNSEC provider.
...
// ImageEdit is not supported by the HCNSEC provider.
...
// ImageEditStream is not supported by the HCNSEC provider.
...
// ImageVariation is not supported by the HCNSEC provider.
...
// VideoGeneration is not supported by the HCNSEC provider.
...
// VideoRetrieve is not supported by the HCNSEC provider.
...
// VideoDownload is not supported by the HCNSEC provider.
...
// VideoDelete is not supported by the HCNSEC provider.
...
// VideoList is not supported by the HCNSEC provider.
...
// VideoRemix is not supported by the HCNSEC provider.
...
// BatchCreate is not supported by the HCNSEC provider.
...
// BatchList is not supported by the HCNSEC provider.
...
// BatchRetrieve is not supported by the HCNSEC provider.
...
// BatchCancel is not supported by the HCNSEC provider.
...
// BatchDelete is not supported by the HCNSEC provider.
...
// BatchResults is not supported by the HCNSEC provider.
...
// FileUpload is not supported by the HCNSEC provider.
...
// FileList is not supported by the HCNSEC provider.
...
// FileRetrieve is not supported by the HCNSEC provider.
...
// FileDelete is not supported by the HCNSEC provider.
...
// FileContent is not supported by the HCNSEC provider.
...
// CachedContentCreate is not supported by the HCNSEC provider.
...
// CachedContentList is not supported by the HCNSEC provider.
...
// CachedContentRetrieve is not supported by the HCNSEC provider.
...
// CachedContentUpdate is not supported by the HCNSEC provider.
...
// CachedContentDelete is not supported by the HCNSEC provider.
...
// CountTokens is not supported by the HCNSEC provider.
...
// Compaction is not supported by the HCNSEC provider.
...
// ContainerCreate is not supported by the HCNSEC provider.
...
// ContainerList is not supported by the HCNSEC provider.
...
// ContainerRetrieve is not supported by the HCNSEC provider.
...
// ContainerDelete is not supported by the HCNSEC provider.
...
// ContainerFileCreate is not supported by the HCNSEC provider.
...
// ContainerFileList is not supported by the HCNSEC provider.
...
// ContainerFileRetrieve is not supported by the HCNSEC provider.
...
// ContainerFileContent is not supported by the HCNSEC provider.
...
// ContainerFileDelete is not supported by the HCNSEC provider.
...
// Passthrough is not supported by the HCNSEC provider.
...
// PassthroughStream is not supported by the HCNSEC provider.

...
// Provider is the OpenAI-compatible provider implementation for TokenHarbor.
...
// NewTokenHarborProvider creates a new TokenHarbor provider instance.
func NewTokenHarborProvider(config *schemas.ProviderConfig, logger schemas.Logger) (*Provider, error) {
	...
	if config.NetworkConfig.BaseURL == "" {
		config.NetworkConfig.BaseURL = "https://tokenharbor.ai/v1"
	}
...
// GetProviderKey returns the provider identifier for TokenHarbor.
func (provider *Provider) GetProviderKey() schemas.ModelProvider {
	return schemas.TokenHarbor
}

// ListModels performs a list models request to TokenHarbor's API.
...
// TextCompletion is not supported by the TokenHarbor provider.
...
// TextCompletionStream is not supported by the TokenHarbor provider.
...
// ChatCompletion performs a chat completion request to the TokenHarbor API.
...
// ChatCompletionStream performs a streaming chat completion request to the TokenHarbor API.
...
// Responses performs a responses request to the TokenHarbor API.
...
// ResponsesStream performs a streaming responses request to the TokenHarbor API.
...
// Embedding is not supported by the TokenHarbor provider.
...
// Speech is not supported by the TokenHarbor provider.
...
// Rerank is not supported by the TokenHarbor provider.
...
// SpeechStream is not supported by the TokenHarbor provider.
...
// Transcription is not supported by the TokenHarbor provider.
...
// TranscriptionStream is not supported by the TokenHarbor provider.
...
// ImageGeneration is not supported by the TokenHarbor provider.
...
// ImageGenerationStream is not supported by the TokenHarbor provider.
...
// ImageEdit is not supported by the TokenHarbor provider.
...
// ImageEditStream is not supported by the TokenHarbor provider.
...
// ImageVariation is not supported by the TokenHarbor provider.
...
// VideoGeneration is not supported by the TokenHarbor provider.
...
// VideoRetrieve is not supported by the TokenHarbor provider.
...
// VideoDownload is not supported by the TokenHarbor provider.
...
// VideoDelete is not supported by the TokenHarbor provider.
...
// VideoList is not supported by the TokenHarbor provider.
...
// VideoRemix is not supported by the TokenHarbor provider.
...
// BatchCreate is not supported by the TokenHarbor provider.
...
// BatchList is not supported by the TokenHarbor provider.
...
// BatchRetrieve is not supported by the TokenHarbor provider.
...
// BatchCancel is not supported by the TokenHarbor provider.
...
// BatchDelete is not supported by the TokenHarbor provider.
...
// BatchResults is not supported by the TokenHarbor provider.
...
// FileUpload is not supported by the TokenHarbor provider.
...
// FileList is not supported by the TokenHarbor provider.
...
// FileRetrieve is not supported by the TokenHarbor provider.
...
// FileDelete is not supported by the TokenHarbor provider.
...
// FileContent is not supported by the TokenHarbor provider.
...
// CachedContentCreate is not supported by the TokenHarbor provider.
...
// CachedContentList is not supported by the TokenHarbor provider.
...
// CachedContentRetrieve is not supported by the TokenHarbor provider.
...
// CachedContentUpdate is not supported by the TokenHarbor provider.
...
// CachedContentDelete is not supported by the TokenHarbor provider.
...
// CountTokens is not supported by the TokenHarbor provider.
...
// Compaction is not supported by the TokenHarbor provider.
...
// ContainerCreate is not supported by the TokenHarbor provider.
...
// ContainerList is not supported by the TokenHarbor provider.
...
// ContainerRetrieve is not supported by the TokenHarbor provider.
...
// ContainerDelete is not supported by the TokenHarbor provider.
...
// ContainerFileCreate is not supported by the TokenHarbor provider.
...
// ContainerFileList is not supported by the TokenHarbor provider.
...
// ContainerFileRetrieve is not supported by the TokenHarbor provider.
...
// ContainerFileContent is not supported by the TokenHarbor provider.
...
// ContainerFileDelete is not supported by the TokenHarbor provider.
...
// Passthrough is not supported by the TokenHarbor provider.
...
// PassthroughStream is not supported by the TokenHarbor provider.

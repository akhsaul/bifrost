...
// Provider implements the Provider interface for BytePlus's API.
...
func NewBytePlusProvider(config *schemas.ProviderConfig, logger schemas.Logger) (*Provider, error) {
	...
	if config.NetworkConfig.BaseURL == "" {
		config.NetworkConfig.BaseURL = "https://ark.ap-southeast.bytepluses.com/api/v3"
	}
...
// ListModels performs a list models request to BytePlus's API.
...
// ChatCompletion performs a chat completion request to the BytePlus API.
...
// ChatCompletionStream performs a streaming chat completion request to the BytePlus API.
...
// Responses performs a responses request to the BytePlus API.
...
// ResponsesStream performs a streaming responses request to the BytePlus API.
...
// CachedContentCreate is not supported by the BytePlus provider.
...
// CachedContentList is not supported by the BytePlus provider.
...
// CachedContentRetrieve is not supported by the BytePlus provider.
...
// CachedContentUpdate is not supported by the BytePlus provider.
...
// CachedContentDelete is not supported by the BytePlus provider.
...
// PassthroughStream is not supported by the BytePlus provider.

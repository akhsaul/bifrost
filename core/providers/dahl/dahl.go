...
// Provider implements the Provider interface for Dahl's API.
...
// NewDahlProvider creates a new Dahl provider instance.
func NewDahlProvider(config *schemas.ProviderConfig, logger schemas.Logger) (*Provider, error) {
	...
	if config.NetworkConfig.BaseURL == "" {
		config.NetworkConfig.BaseURL = "https://inference.dahl.global/v1"
	}
...
// GetProviderKey returns the provider identifier for Dahl.
func (provider *Provider) GetProviderKey() schemas.ModelProvider {
	return schemas.Dahl
}

// ListModels performs a list models request to Dahl's API.
...
// TextCompletion is not supported by the Dahl provider.
...
// TextCompletionStream is not supported by the Dahl provider.
...
// ChatCompletion performs a chat completion request to the Dahl API.
...
// ChatCompletionStream performs a streaming chat completion request to the Dahl API.
...
// Responses performs a responses request to the Dahl API.
...
// ResponsesStream performs a streaming responses request to the Dahl API.
...
// Embedding is not supported by the Dahl provider.
...
// Speech is not supported by the Dahl provider.
...
// Rerank is not supported by the Dahl provider.
...
// OCR is not supported by the Dahl provider.
...
// SpeechStream is not supported by the Dahl provider.
...
// Transcription is not supported by the Dahl provider.
...
// TranscriptionStream is not supported by the Dahl provider.
...
// ImageGeneration is not supported by the Dahl provider.
...
// ImageGenerationStream is not supported by the Dahl provider.
...
// ImageEdit is not supported by the Dahl provider.
...
// ImageEditStream is not supported by the Dahl provider.
...
// ImageVariation is not supported by the Dahl provider.
...
// VideoGeneration is not supported by the Dahl provider.
...
// VideoRetrieve is not supported by the Dahl provider.
...
// VideoDownload is not supported by the Dahl provider.
...
// VideoDelete is not supported by the Dahl provider.
...
// VideoList is not supported by the Dahl provider.
...
// VideoRemix is not supported by the Dahl provider.
...
// BatchCreate is not supported by the Dahl provider.
...
// BatchList is not supported by the Dahl provider.
...
// BatchRetrieve is not supported by the Dahl provider.
...
// BatchCancel is not supported by the Dahl provider.
...
// BatchDelete is not supported by the Dahl provider.
...
// BatchResults is not supported by the Dahl provider.
...
// FileUpload is not supported by the Dahl provider.
...
// FileList is not supported by the Dahl provider.
...
// FileRetrieve is not supported by the Dahl provider.
...
// FileDelete is not supported by the Dahl provider.
...
// FileContent is not supported by the Dahl provider.
...
// CachedContentCreate is not supported by the Dahl provider.
...
// CachedContentList is not supported by the Dahl provider.
...
// CachedContentRetrieve is not supported by the Dahl provider.
...
// CachedContentUpdate is not supported by the Dahl provider.
...
// CachedContentDelete is not supported by the Dahl provider.
...
// CountTokens is not supported by the Dahl provider.
...
// Compaction is not supported by the Dahl provider.
...
// ContainerCreate is not supported by the Dahl provider.
...
// ContainerList is not supported by the Dahl provider.
...
// ContainerRetrieve is not supported by the Dahl provider.
...
// ContainerDelete is not supported by the Dahl provider.
...
// ContainerFileCreate is not supported by the Dahl provider.
...
// ContainerFileList is not supported by the Dahl provider.
...
// ContainerFileRetrieve is not supported by the Dahl provider.
...
// ContainerFileContent is not supported by the Dahl provider.
...
// ContainerFileDelete is not supported by the Dahl provider.
...
// Passthrough is not supported by the Dahl provider.
...
// PassthroughStream is not supported by the Dahl provider.

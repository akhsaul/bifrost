// Package seekai implements SeekAI's OpenAI-compatible API.
package seekai
...
// Provider is the OpenAI-compatible provider implementation for SeekAI.
...
// NewSeekAIProvider creates a SeekAI provider.
func NewSeekAIProvider(config *schemas.ProviderConfig, logger schemas.Logger) (*Provider, error) {
	...
	if config.NetworkConfig.BaseURL == "" {
		config.NetworkConfig.BaseURL = "https://seekai.cc/v1"
	}
...
// GetProviderKey returns the provider identifier for SeekAI.
func (provider *Provider) GetProviderKey() schemas.ModelProvider {
	return schemas.SeekAI
}

// ListModels performs a list models request to SeekAI's API.
...
// TextCompletion is not supported by the SeekAI provider.
...
// TextCompletionStream is not supported by the SeekAI provider.
...
// ChatCompletion performs a chat completion request to the SeekAI API.
...
// ChatCompletionStream performs a streaming chat completion request to the SeekAI API.
...
// Responses performs a responses request to the SeekAI API.
...
// ResponsesStream performs a streaming responses request to the SeekAI API.
...
// Embedding is not supported by the SeekAI provider.
...
// Speech is not supported by the SeekAI provider.
...
// Rerank is not supported by the SeekAI provider.
...
// OCR is not supported by the SeekAI provider.
...
// SpeechStream is not supported by the SeekAI provider.
...
// Transcription is not supported by the SeekAI provider.
...
// TranscriptionStream is not supported by the SeekAI provider.
...
// ImageGeneration is not supported by the SeekAI provider.
...
// ImageGenerationStream is not supported by the SeekAI provider.
...
// ImageEdit is not supported by the SeekAI provider.
...
// ImageEditStream is not supported by the SeekAI provider.
...
// ImageVariation is not supported by the SeekAI provider.
...
// VideoGeneration is not supported by the SeekAI provider.
...
// VideoRetrieve is not supported by the SeekAI provider.
...
// VideoDownload is not supported by the SeekAI provider.
...
// VideoDelete is not supported by the SeekAI provider.
...
// VideoList is not supported by the SeekAI provider.
...
// VideoRemix is not supported by the SeekAI provider.
...
// BatchCreate is not supported by the SeekAI provider.
...
// BatchList is not supported by the SeekAI provider.
...
// BatchRetrieve is not supported by the SeekAI provider.
...
// BatchCancel is not supported by the SeekAI provider.
...
// BatchDelete is not supported by the SeekAI provider.
...
// BatchResults is not supported by the SeekAI provider.
...
// FileUpload is not supported by the SeekAI provider.
...
// FileList is not supported by the SeekAI provider.
...
// FileRetrieve is not supported by the SeekAI provider.
...
// FileDelete is not supported by the SeekAI provider.
...
// FileContent is not supported by the SeekAI provider.
...
// CachedContentCreate is not supported by the SeekAI provider.
...
// CachedContentList is not supported by the SeekAI provider.
...
// CachedContentRetrieve is not supported by the SeekAI provider.
...
// CachedContentUpdate is not supported by the SeekAI provider.
...
// CachedContentDelete is not supported by the SeekAI provider.
...
// CountTokens is not supported by the SeekAI provider.
...
// Compaction is not supported by the SeekAI provider.
...
// ContainerCreate is not supported by the SeekAI provider.
...
// ContainerList is not supported by the SeekAI provider.
...
// ContainerRetrieve is not supported by the SeekAI provider.
...
// ContainerDelete is not supported by the SeekAI provider.
...
// ContainerFileCreate is not supported by the SeekAI provider.
...
// ContainerFileList is not supported by the SeekAI provider.
...
// ContainerFileRetrieve is not supported by the SeekAI provider.
...
// ContainerFileContent is not supported by the SeekAI provider.
...
// ContainerFileDelete is not supported by the SeekAI provider.
...
// Passthrough is not supported by the SeekAI provider.
...
// PassthroughStream is not supported by the SeekAI provider.

// Package gorouter implements GoRouter's OpenAI-compatible API.
package gorouter
...
// Provider is the OpenAI-compatible provider implementation for GoRouter.
...
// NewGoRouterProvider creates a GoRouter provider.
func NewGoRouterProvider(config *schemas.ProviderConfig, logger schemas.Logger) (*Provider, error) {
	...
	if config.NetworkConfig.BaseURL == "" {
		config.NetworkConfig.BaseURL = "https://gorouter.app/v1"
	}
...
// GetProviderKey returns the provider identifier for GoRouter.
func (provider *Provider) GetProviderKey() schemas.ModelProvider {
	return schemas.GoRouter
}

// ListModels performs a list models request to GoRouter's API.
...
// TextCompletion is not supported by the GoRouter provider.
...
// TextCompletionStream is not supported by the GoRouter provider.
...
// ChatCompletion performs a chat completion request to the GoRouter API.
...
// ChatCompletionStream performs a streaming chat completion request to the GoRouter API.
...
// Responses performs a responses request to the GoRouter API.
...
// ResponsesStream performs a streaming responses request to the GoRouter API.
...
// Embedding is not supported by the GoRouter provider.
...
// Speech is not supported by the GoRouter provider.
...
// Rerank is not supported by the GoRouter provider.
...
// OCR is not supported by the GoRouter provider.
...
// SpeechStream is not supported by the GoRouter provider.
...
// Transcription is not supported by the GoRouter provider.
...
// TranscriptionStream is not supported by the GoRouter provider.
...
// ImageGeneration is not supported by the GoRouter provider.
...
// ImageGenerationStream is not supported by the GoRouter provider.
...
// ImageEdit is not supported by the GoRouter provider.
...
// ImageEditStream is not supported by the GoRouter provider.
...
// ImageVariation is not supported by the GoRouter provider.
...
// VideoGeneration is not supported by the GoRouter provider.
...
// VideoRetrieve is not supported by the GoRouter provider.
...
// VideoDownload is not supported by the GoRouter provider.
...
// VideoDelete is not supported by the GoRouter provider.
...
// VideoList is not supported by the GoRouter provider.
...
// VideoRemix is not supported by the GoRouter provider.
...
// BatchCreate is not supported by the GoRouter provider.
...
// BatchList is not supported by the GoRouter provider.
...
// BatchRetrieve is not supported by the GoRouter provider.
...
// BatchCancel is not supported by the GoRouter provider.
...
// BatchDelete is not supported by the GoRouter provider.
...
// BatchResults is not supported by the GoRouter provider.
...
// FileUpload is not supported by the GoRouter provider.
...
// FileList is not supported by the GoRouter provider.
...
// FileRetrieve is not supported by the GoRouter provider.
...
// FileDelete is not supported by the GoRouter provider.
...
// FileContent is not supported by the GoRouter provider.
...
// CachedContentCreate is not supported by the GoRouter provider.
...
// CachedContentList is not supported by the GoRouter provider.
...
// CachedContentRetrieve is not supported by the GoRouter provider.
...
// CachedContentUpdate is not supported by the GoRouter provider.
...
// CachedContentDelete is not supported by the GoRouter provider.
...
// CountTokens is not supported by the GoRouter provider.
...
// Compaction is not supported by the GoRouter provider.
...
// ContainerCreate is not supported by the GoRouter provider.
...
// ContainerList is not supported by the GoRouter provider.
...
// ContainerRetrieve is not supported by the GoRouter provider.
...
// ContainerDelete is not supported by the GoRouter provider.
...
// ContainerFileCreate is not supported by the GoRouter provider.
...
// ContainerFileList is not supported by the GoRouter provider.
...
// ContainerFileRetrieve is not supported by the GoRouter provider.
...
// ContainerFileContent is not supported by the GoRouter provider.
...
// ContainerFileDelete is not supported by the GoRouter provider.
...
// Passthrough is not supported by the GoRouter provider.
...
// PassthroughStream is not supported by the GoRouter provider.

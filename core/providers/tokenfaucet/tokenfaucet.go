...
// Provider is the OpenAI-compatible provider implementation for TokenFaucet.
...
func NewTokenFaucetProvider(config *schemas.ProviderConfig, logger schemas.Logger) (*Provider, error) {
	...
	if config.NetworkConfig.BaseURL == "" {
		config.NetworkConfig.BaseURL = "https://freetokenfaucet.com/v1"
	}
...
// GetProviderKey returns the provider identifier for TokenFaucet.
func (provider *Provider) GetProviderKey() schemas.ModelProvider {
	return schemas.TokenFaucet
}

// ListModels performs a list models request to TokenFaucet's API.
...
// TextCompletion is not supported by the TokenFaucet provider.
...
// TextCompletionStream is not supported by the TokenFaucet provider.
...
// ChatCompletion performs a chat completion request to the TokenFaucet API.
...
// ChatCompletionStream performs a streaming chat completion request to the TokenFaucet API.
...
// Responses performs a responses request to the TokenFaucet API.
...
// ResponsesStream performs a streaming responses request to the TokenFaucet API.
...
// Embedding is not supported by the TokenFaucet provider.
...
// Speech is not supported by the TokenFaucet provider.
...
// Rerank is not supported by the TokenFaucet provider.
...
// OCR is not supported by the TokenFaucet provider.
...
// SpeechStream is not supported by the TokenFaucet provider.
...
// Transcription is not supported by the TokenFaucet provider.
...
// TranscriptionStream is not supported by the TokenFaucet provider.
...
// ImageGeneration is not supported by the TokenFaucet provider.
...
// ImageGenerationStream is not supported by the TokenFaucet provider.
...
// ImageEdit is not supported by the TokenFaucet provider.
...
// ImageEditStream is not supported by the TokenFaucet provider.
...
// ImageVariation is not supported by the TokenFaucet provider.
...
// VideoGeneration is not supported by the TokenFaucet provider.
...
// VideoRetrieve is not supported by the TokenFaucet provider.
...
// VideoDownload is not supported by the TokenFaucet provider.
...
// VideoDelete is not supported by the TokenFaucet provider.
...
// VideoList is not supported by the TokenFaucet provider.
...
// VideoRemix is not supported by the TokenFaucet provider.
...
// BatchCreate is not supported by the TokenFaucet provider.
...
// BatchList is not supported by the TokenFaucet provider.
...
// BatchRetrieve is not supported by the TokenFaucet provider.
...
// BatchCancel is not supported by the TokenFaucet provider.
...
// BatchDelete is not supported by the TokenFaucet provider.
...
// BatchResults is not supported by the TokenFaucet provider.
...
// FileUpload is not supported by the TokenFaucet provider.
...
// FileList is not supported by the TokenFaucet provider.
...
// FileRetrieve is not supported by the TokenFaucet provider.
...
// FileDelete is not supported by the TokenFaucet provider.
...
// FileContent is not supported by the TokenFaucet provider.
...
// CachedContentCreate is not supported by the TokenFaucet provider.
...
// CachedContentList is not supported by the TokenFaucet provider.
...
// CachedContentRetrieve is not supported by the TokenFaucet provider.
...
// CachedContentUpdate is not supported by the TokenFaucet provider.
...
// CachedContentDelete is not supported by the TokenFaucet provider.
...
// CountTokens is not supported by the TokenFaucet provider.
...
// Compaction is not supported by the TokenFaucet provider.
...
// ContainerCreate is not supported by the TokenFaucet provider.
...
// ContainerList is not supported by the TokenFaucet provider.
...
// ContainerRetrieve is not supported by the TokenFaucet provider.
...
// ContainerDelete is not supported by the TokenFaucet provider.
...
// ContainerFileCreate is not supported by the TokenFaucet provider.
...
// ContainerFileList is not supported by the TokenFaucet provider.
...
// ContainerFileRetrieve is not supported by the TokenFaucet provider.
...
// ContainerFileContent is not supported by the TokenFaucet provider.
...
// ContainerFileDelete is not supported by the TokenFaucet provider.
...
// Passthrough is not supported by the TokenFaucet provider.
...
// PassthroughStream is not supported by the TokenFaucet provider.

...
// Provider is the OpenAI-compatible provider implementation for Longcat.
...
func NewLongcatProvider(config *schemas.ProviderConfig, logger schemas.Logger) (*Provider, error) {
	...
	if config.NetworkConfig.BaseURL == "" {
		config.NetworkConfig.BaseURL = "https://api.longcat.chat/openai/v1"
	}
...
// ChatCompletion performs a chat completion request to the Longcat API.
...
// ChatCompletionStream performs a streaming chat completion request to the Longcat API.
...
// Responses performs a responses request to the Longcat API.
...
// ResponsesStream performs a streaming responses request to the Longcat API.
...
// VideoDelete is not supported by the Longcat provider.
...
// VideoList is not supported by the Longcat provider.
...
// VideoRemix is not supported by the Longcat provider.
...
// BatchCreate is not supported by the Longcat provider.
...
// BatchList is not supported by the Longcat provider.
...
// BatchRetrieve is not supported by the Longcat provider.
...
// BatchCancel is not supported by the Longcat provider.
...
// BatchDelete is not supported by the Longcat provider.
...
// BatchResults is not supported by the Longcat provider.
...
// FileUpload is not supported by the Longcat provider.
...
// FileList is not supported by the Longcat provider.
...
// FileRetrieve is not supported by the Longcat provider.
...
// FileDelete is not supported by the Longcat provider.
...
// FileContent is not supported by the Longcat provider.
...
// CachedContentCreate is not supported by the Longcat provider.
...
// CachedContentList is not supported by the Longcat provider.
...
// CachedContentRetrieve is not supported by the Longcat provider.
...
// CachedContentUpdate is not supported by the Longcat provider.
...
// CachedContentDelete is not supported by the Longcat provider.

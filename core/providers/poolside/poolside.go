...
// Provider is the OpenAI-compatible provider implementation for Poolside.
...
// NewPoolsideProvider creates a new Poolside provider instance.
func NewPoolsideProvider(config *schemas.ProviderConfig, logger schemas.Logger) (*Provider, error) {
	...
	if config.NetworkConfig.BaseURL == "" {
		config.NetworkConfig.BaseURL = "https://inference.poolside.ai/v1"
	}
...
// GetProviderKey returns the provider identifier for Poolside.
func (provider *Provider) GetProviderKey() schemas.ModelProvider {
	return schemas.Poolside
}

// ListModels performs a list models request to Poolside's API.
...
// TextCompletion is not supported by the Poolside provider.
...
// TextCompletionStream is not supported by the Poolside provider.
...
// ChatCompletion performs a chat completion request to the Poolside API.
...
// ChatCompletionStream performs a streaming chat completion request to the Poolside API.
...
// Responses performs a responses request to the Poolside API.
...
// ResponsesStream performs a streaming responses request to the Poolside API.
...
// Embedding is not supported by the Poolside provider.
...
// Speech is not supported by the Poolside provider.
...
// Rerank is not supported by the Poolside provider.
...
// OCR is not supported by the Poolside provider.
...
// SpeechStream is not supported by the Poolside provider.
...
// Transcription is not supported by the Poolside provider.
...
// TranscriptionStream is not supported by the Poolside provider.
...
// ImageGeneration is not supported by the Poolside provider.
...
// ImageGenerationStream is not supported by the Poolside provider.
...
// ImageEdit is not supported by the Poolside provider.
...
// ImageEditStream is not supported by the Poolside provider.
...
// ImageVariation is not supported by the Poolside provider.
...
// VideoGeneration is not supported by the Poolside provider.
...
// VideoRetrieve is not supported by the Poolside provider.
...
// VideoDownload is not supported by the Poolside provider.
...
// VideoDelete is not supported by the Poolside provider.
...
// VideoList is not supported by the Poolside provider.
...
// VideoRemix is not supported by the Poolside provider.
...
// BatchCreate is not supported by the Poolside provider.
...
// BatchList is not supported by the Poolside provider.
...
// BatchRetrieve is not supported by the Poolside provider.
...
// BatchCancel is not supported by the Poolside provider.
...
// BatchDelete is not supported by the Poolside provider.
...
// BatchResults is not supported by the Poolside provider.
...
// FileUpload is not supported by the Poolside provider.
...
// FileList is not supported by the Poolside provider.
...
// FileRetrieve is not supported by the Poolside provider.
...
// FileDelete is not supported by the Poolside provider.
...
// FileContent is not supported by the Poolside provider.
...
// CachedContentCreate is not supported by the Poolside provider.
...
// CachedContentList is not supported by the Poolside provider.
...
// CachedContentRetrieve is not supported by the Poolside provider.
...
// CachedContentUpdate is not supported by the Poolside provider.
...
// CachedContentDelete is not supported by the Poolside provider.
...
// CountTokens is not supported by the Poolside provider.
...
// Compaction is not supported by the Poolside provider.
...
// ContainerCreate is not supported by the Poolside provider.
...
// ContainerList is not supported by the Poolside provider.
...
// ContainerRetrieve is not supported by the Poolside provider.
...
// ContainerDelete is not supported by the Poolside provider.
...
// ContainerFileCreate is not supported by the Poolside provider.
...
// ContainerFileList is not supported by the Poolside provider.
...
// ContainerFileRetrieve is not supported by the Poolside provider.
...
// ContainerFileContent is not supported by the Poolside provider.
...
// ContainerFileDelete is not supported by the Poolside provider.
...
// Passthrough is not supported by the Poolside provider.
...
// PassthroughStream is not supported by the Poolside provider.

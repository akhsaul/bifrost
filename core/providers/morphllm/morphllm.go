...
// Provider is the OpenAI-compatible provider implementation for Morphllm.
...
// NewMorphllmProvider creates a new Morphllm provider instance.
func NewMorphllmProvider(config *schemas.ProviderConfig, logger schemas.Logger) (*Provider, error) {
	...
	if config.NetworkConfig.BaseURL == "" {
		config.NetworkConfig.BaseURL = "https://api.morphllm.com/v1"
	}
...
// GetProviderKey returns the provider identifier for Morphllm.
func (provider *Provider) GetProviderKey() schemas.ModelProvider {
	return schemas.Morphllm
}

// ListModels performs a list models request to Morphllm's API.
...
// TextCompletion is not supported by the Morphllm provider.
...
// TextCompletionStream is not supported by the Morphllm provider.
...
// ChatCompletion performs a chat completion request to the Morphllm API.
...
// ChatCompletionStream performs a streaming chat completion request to the Morphllm API.
...
// Responses performs a responses request to the Morphllm API.
...
// ResponsesStream performs a streaming responses request to the Morphllm API.
...
// Embedding is not supported by the Morphllm provider.
...
// Speech is not supported by the Morphllm provider.
...
// Rerank is not supported by the Morphllm provider.
...
// OCR is not supported by the Morphllm provider.
...
// SpeechStream is not supported by the Morphllm provider.
...
// Transcription is not supported by the Morphllm provider.
...
// TranscriptionStream is not supported by the Morphllm provider.
...
// ImageGeneration is not supported by the Morphllm provider.
...
// ImageGenerationStream is not supported by the Morphllm provider.
...
// ImageEdit is not supported by the Morphllm provider.
...
// ImageEditStream is not supported by the Morphllm provider.
...
// ImageVariation is not supported by the Morphllm provider.
...
// VideoGeneration is not supported by the Morphllm provider.
...
// VideoRetrieve is not supported by the Morphllm provider.
...
// VideoDownload is not supported by the Morphllm provider.
...
// VideoDelete is not supported by the Morphllm provider.
...
// VideoList is not supported by the Morphllm provider.
...
// VideoRemix is not supported by the Morphllm provider.
...
// BatchCreate is not supported by the Morphllm provider.
...
// BatchList is not supported by the Morphllm provider.
...
// BatchRetrieve is not supported by the Morphllm provider.
...
// BatchCancel is not supported by the Morphllm provider.
...
// BatchDelete is not supported by the Morphllm provider.
...
// BatchResults is not supported by the Morphllm provider.
...
// FileUpload is not supported by the Morphllm provider.
...
// FileList is not supported by the Morphllm provider.
...
// FileRetrieve is not supported by the Morphllm provider.
...
// FileDelete is not supported by the Morphllm provider.
...
// FileContent is not supported by the Morphllm provider.
...
// CachedContentCreate is not supported by the Morphllm provider.
...
// CachedContentList is not supported by the Morphllm provider.
...
// CachedContentRetrieve is not supported by the Morphllm provider.
...
// CachedContentUpdate is not supported by the Morphllm provider.
...
// CachedContentDelete is not supported by the Morphllm provider.
...
// CountTokens is not supported by the Morphllm provider.
...
// Compaction is not supported by the Morphllm provider.
...
// ContainerCreate is not supported by the Morphllm provider.
...
// ContainerList is not supported by the Morphllm provider.
...
// ContainerRetrieve is not supported by the Morphllm provider.
...
// ContainerDelete is not supported by the Morphllm provider.
...
// ContainerFileCreate is not supported by the Morphllm provider.
...
// ContainerFileList is not supported by the Morphllm provider.
...
// ContainerFileRetrieve is not supported by the Morphllm provider.
...
// ContainerFileContent is not supported by the Morphllm provider.
...
// ContainerFileDelete is not supported by the Morphllm provider.
...
// Passthrough is not supported by the Morphllm provider.
...
// PassthroughStream is not supported by the Morphllm provider.

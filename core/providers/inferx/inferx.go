...
// Provider is the OpenAI-compatible provider implementation for Inferx.
...
func NewInferxProvider(config *schemas.ProviderConfig, logger schemas.Logger) (*Provider, error) {
	...
	if config.NetworkConfig.BaseURL == "" {
		config.NetworkConfig.BaseURL = "https://model.inferx.net/endpoints/v1"
	}
...
// GetProviderKey returns the provider identifier for Inferx.
func (provider *Provider) GetProviderKey() schemas.ModelProvider {
	return schemas.Inferx
}

// ListModels performs a list models request to Inferx's API.
...
// TextCompletion is not supported by the Inferx provider.
...
// TextCompletionStream is not supported by the Inferx provider.
...
// ChatCompletion performs a chat completion request to the Inferx API.
...
// ChatCompletionStream performs a streaming chat completion request to the Inferx API.
...
// Responses performs a responses request to the Inferx API.
...
// ResponsesStream performs a streaming responses request to the Inferx API.
...
// Embedding is not supported by the Inferx provider.
...
// Speech is not supported by the Inferx provider.
...
// Rerank is not supported by the Inferx provider.
...
// OCR is not supported by the Inferx provider.
...
// SpeechStream is not supported by the Inferx provider.
...
// Transcription is not supported by the Inferx provider.
...
// TranscriptionStream is not supported by the Inferx provider.
...
// ImageGeneration is not supported by the Inferx provider.
...
// ImageGenerationStream is not supported by the Inferx provider.
...
// ImageEdit is not supported by the Inferx provider.
...
// ImageEditStream is not supported by the Inferx provider.
...
// ImageVariation is not supported by the Inferx provider.
...
// VideoGeneration is not supported by the Inferx provider.
...
// VideoRetrieve is not supported by the Inferx provider.
...
// VideoDownload is not supported by the Inferx provider.
...
// VideoDelete is not supported by the Inferx provider.
...
// VideoList is not supported by the Inferx provider.
...
// VideoRemix is not supported by the Inferx provider.
...
// BatchCreate is not supported by the Inferx provider.
...
// BatchList is not supported by the Inferx provider.
...
// BatchRetrieve is not supported by the Inferx provider.
...
// BatchCancel is not supported by the Inferx provider.
...
// BatchDelete is not supported by the Inferx provider.
...
// BatchResults is not supported by the Inferx provider.
...
// FileUpload is not supported by the Inferx provider.
...
// FileList is not supported by the Inferx provider.
...
// FileRetrieve is not supported by the Inferx provider.
...
// FileDelete is not supported by the Inferx provider.
...
// FileContent is not supported by the Inferx provider.
...
// CachedContentCreate is not supported by the Inferx provider.
...
// CachedContentList is not supported by the Inferx provider.
...
// CachedContentRetrieve is not supported by the Inferx provider.
...
// CachedContentUpdate is not supported by the Inferx provider.
...
// CachedContentDelete is not supported by the Inferx provider.
...
// CountTokens is not supported by the Inferx provider.
...
// Compaction is not supported by the Inferx provider.
...
// ContainerCreate is not supported by the Inferx provider.
...
// ContainerList is not supported by the Inferx provider.
...
// ContainerRetrieve is not supported by the Inferx provider.
...
// ContainerDelete is not supported by the Inferx provider.
...
// ContainerFileCreate is not supported by the Inferx provider.
...
// ContainerFileList is not supported by the Inferx provider.
...
// ContainerFileRetrieve is not supported by the Inferx provider.
...
// ContainerFileContent is not supported by the Inferx provider.
...
// ContainerFileDelete is not supported by the Inferx provider.
...
// Passthrough is not supported by the Inferx provider.
...
// PassthroughStream is not supported by the Inferx provider.
